    ...
    async execute(message) {
        const helpEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                { name: '$echo #channel-name message', value: 'Sends message to specific channel by name (MODs Command)' },
                { name: '$echo -e #channel-name message', value: 'Sends message in an embed to specific channel by name (MODs Command)' },
