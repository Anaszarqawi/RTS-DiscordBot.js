...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('unmute')
        .setDescription("Um-mute all/role/user from voice channel")
        .addRoleOption(option =>
            option.setName('role')
                .setDescription('Um-mute all users who have a specific role')
                .setRequired(false))
        .addUserOption(option =>
            option.setName('user')
                .setDescription('Um-mute specific user')
                .setRequired(false)),
    ...
    async execute(interaction) {
        ...
        if (inChannel && canMuteUsers) {
            ...
            interaction.reply({
                content: `**You are not in the channel or you don't have MODs Role!**`,
                ephemeral: true
            })
        }
    }
